...
impl AudioPlayer {
    ...
    pub fn set_url(&self, url: &str) -> Result<Option<u64>, String> {
        ...
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = url; Err("Audio not supported on this platform".into()) }
    }
    ...
    pub fn set_file_path(&self, path: &str) -> Result<Option<u64>, String> {
        ...
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = path; Err("Audio not supported on this platform".into()) }
    }
    ...
    pub fn seek(&self, position_ms: u64) -> Result<(), String> {
        ...
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = position_ms; Err("Audio not supported on this platform".into()) }
    }
    ...
    pub fn set_volume(&self, volume: f32) -> Result<(), String> {
        ...
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = volume; Err("Audio not supported on this platform".into()) }
    }
    ...
    pub fn set_speed(&self, speed: f32) -> Result<(), String> {
        ...
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = speed; Err("Audio not supported on this platform".into()) }
    }
    ...
    pub fn set_loop_mode(&self, mode: LoopMode) -> Result<(), String> {
        ...
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = mode; Err("Audio not supported on this platform".into()) }
    }
