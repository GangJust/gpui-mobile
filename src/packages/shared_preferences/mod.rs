...
impl SharedPreferences {
    ...
    pub fn instance() -> Self {
        #[cfg(target_os = "ios")]
        { Self { inner: ios::IosSharedPreferences::new() } }
        #[cfg(target_os = "android")]
        { Self { inner: android::AndroidSharedPreferences::new() } }
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { Self { inner: () } }
    }
    ...
    pub fn set_string(&self, key: &str, value: &str) -> Result<(), String> {
        ...
        { self.inner.set_string(key, value) }
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = (key, value); Err("Not supported".into()) }
    }
    ...
    pub fn remove(&self, key: &str) -> Result<(), String> {
        ...
        { self.inner.remove(key) }
        #[cfg(not(any(target_os = "ios", target_os = "android")))]
        { let _ = key; Err("Not supported".into()) }
    }
